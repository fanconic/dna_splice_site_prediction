...
models = {
    ...
    "Gradient Boosting": lightgbm.LGBMClassifier(n_estimators=700, num_leaves=50),
    # "MLP": MLPClassifier(),
...
for name, model in models.items():
    ...
    if True:
    # evaluating performance on given val set
        test = DataLoader_sk(data_path + hum_seq_val, shuffle=False, preprocess_X=preprocess_transforms)
        predictions = model.predict(test.x)

        print("### performance on val set ###")
